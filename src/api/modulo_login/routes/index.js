...
router.post('/login', [check('correo', 'Debe ser un correo valido y es requerido').isEmail(), check('password', 'La contraseña debe contener al menos 4 dígitos y es requerido').isLength({ min: 6 }), validarCampos], login);
...
router.put('/nuevaContrasenia', [check('password', 'La contraseña debe contener al menos 6 dígitos y es requerido').isLength({ min: 6 }), validarCampos], newPassword);
